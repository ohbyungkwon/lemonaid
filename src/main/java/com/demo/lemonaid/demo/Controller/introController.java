    ...
    public Map<String, Object> disease_choice(@RequestParam String disease_name){
        ...
        if(disease_name.equals("발기부전")) {
            ...
            map.put("treatAndRisk","본 원격 처방 서비스에서 처방하는 발기부전제는 일반적으로 안전하지만 유희용으로 복용되어서는\n" +
                    ...
                    "안내문을 참고하세요.");
            map.put("exceptService","다음 항목 중 하나라도 해당된다면 발기부전 원격 처방 서비스에 적합하지 않으며 서비스 제외\n" +
                    "대상으로 구분 됩니다.\n" +
                    "만 30세 미만, 67세 이상\n" +
                    "여성\n" +
                    "지난 5년간 생식기를 포함한 신체검사를 받지 않은 자\n" +
                    "어떤 이유에서든 성관계가 권장되지 않는 경우\n" +
                    "니트로글리세린이나 질산염이 포함된 약 복용\n" +
                    "혈압을 모르거나 저혈압, 이유 없이 기절이나 어지러움을 경험\n" +
                    "신장 질환자\n" +
                    "간 질환자\n" +
                    "HIV\n" +
                    "페이로니 질병을 포함한 성기의 신체적 기형\n" +
                    "심장 질환, 뇌 질환, 혹은 다른 심혈관 질환자");
            ...
            map.put("intro", "온라인 영상 진룔로 간편하게 진단받고 탈모약 처방 받아 원하는 약국에서 픽업하세요! 탈모약 원격 처방 서비스는 남성형 탈모 환자만을 대상으로 제공하고 있습니다.");
            ...
            map.put("exceptService","다음 항목 중 하나라도 해당된다면 발기부전 원격 처방 서비스에 적합하지 않으며 서비스 제외\n" +
                    ...
                    "만 18세 이하\n" +
                    "여성\n" +
                    "남성형 탈모가 아닌 다른 원인으로 인한 탈모\n" +
                    "피나스테리드에 대한 알레르기\n" +
                    "이미 다른 형식의 피나스테리드를 복용\n" +
                    "간 손상\n" +
                    "배뇨활동의 어려움\n" +
                    "\n" +
                    "전립선 암을 앓고 있거나 병력이 있음\n" +
                    "유방암을 앓고 있거나 병력이 있음");
